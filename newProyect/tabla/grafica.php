...
<hr>
    <h3 class="subtitulo text-center">
        Muestra gráfica del día
    </h3>
    <hr>
<select name="fechas" id="fechas" class="btn btn-light">
    <option value="selecciona">Cargando fechas...</option>
</select>
<table border="1" id="tabla-resultados" class="table table-striped my-2 pt-2">
            <thead>
                <tr>
                    <th scope="col">ID</th>
    ...
    <div>
    <center>
    <div id="contGrafDay" style="width: 700px; height: 300px; display: block;">
